...
register_include(mPHP_PATH.'/_mphp/helpers/Request.php');

//Load the HTTP Class
register_include(mPHP_PATH.'/_mphp/helpers/HTTP.php');
...
if(mPHP_MODE == "DEV" && !Request::IsAjax()) {
	$AssetManager->compile();
}

//Include the application file
register_include(APP_PATH.'/app.php');
